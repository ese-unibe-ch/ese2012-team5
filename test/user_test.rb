...
class UserTest < Test::Unit::TestCase
  ...
  def test_has_bigger_amount
    database = Marketplace::Database.instance
    user = Marketplace::User.create("Heinro",'pW123')
    user.credits += 50
  ...
  def test_has_smaller_amount
    database = Marketplace::Database.instance
    user = Marketplace::User.create("Ulrich",'pW123')
    user.credits -= 50
  ...
  def test_add_item
    database = Marketplace::Database.instance
    # list is empty now
    owner = Marketplace::User.create("Serioso","pW123")
  ...
  def test_buy_item_inactive
    database = Marketplace::Database.instance
    seller = Marketplace::User.create('John','pW123')
    buyer = Marketplace::User.create('Jack','pW123')
  ...
  def test_become_owner_at_trade
    database = Marketplace::Database.instance
    user = Marketplace::User.create("Buyer",'pW123')
    owner = Marketplace::User.create("Owner",'pW123')
